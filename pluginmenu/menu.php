 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_to')){
	function azrcrv_create_plugin_menu_to(){
		azrcrv_populate_plugin_menu_to();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_to')){
	function azrcrv_populate_plugin_menu_to(){
